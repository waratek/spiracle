...
/**
 * Servlet implementation class RandomAccessFileServlet01
 */
@WebServlet("/RandomAccessFileServlet01")
public class RandomAccessFileServlet01 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RandomAccessFileServlet01() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String testFileName = request.getParameter("RandomAccessFile01");
