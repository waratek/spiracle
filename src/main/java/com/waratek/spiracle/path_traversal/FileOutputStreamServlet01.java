...
/**
 * Servlet implementation class FileOutputStreamServlet01
 */
@WebServlet("/FileOutputStreamServlet01")
public class FileOutputStreamServlet01 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FileOutputStreamServlet01() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String testFileName = request.getParameter("FileOutputStream01");
