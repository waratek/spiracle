...
/**
 * Servlet implementation class RandomAccessFileServlet03
 */
@WebServlet("/RandomAccessFileServlet03")
public class RandomAccessFileServlet03 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RandomAccessFileServlet03() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String testFileName = request.getParameter("RandomAccessFile03");
