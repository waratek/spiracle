...
/**
 * Servlet implementation class FileInputStreamServlet02
 */
@WebServlet("/FileInputStreamServlet02")
public class FileInputStreamServlet02 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FileInputStreamServlet02() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String testFileName = request.getParameter("FileInputStream02");
