 ...
 */
@WebServlet("/Sybase_Get_string_param_question_mark")
public class Sybase_Get_string_param_question_mark extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sybase_Get_string_param_question_mark() {
        super();
